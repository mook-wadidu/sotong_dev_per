...
export const DEMO_NARRATION: Partial<Record<string, string>> = {
  lang: "손님은 앱 설치도 가입도 없이 — 자기 언어를 고르고, 원하는 걸 몇 번 탭으로 알려줘요.",
  summary: "이 내용이 상담 전에 미리 이렇게 도착해요.",
  chat: "손님이 영어로 물어봐도 괜찮아요 — 자동으로 번역돼요.",
  inservice: "시술 중엔 손님에게 이렇게 안내돼요.",
  report: "끝나면 손님은 자기 언어로 리포트를 받아요.",
  "d-inbox": "여기서부턴 원장님 화면이에요 — 방금 그 상담이, 한국어로 도착해요.",
  "d-summary": "원장님껜 핵심만 한국어로 요약돼요.",
