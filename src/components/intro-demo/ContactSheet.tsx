...
/**
 * 메일·전화·문자 중 하나를 고르는 선택창(바텀시트).
 * 인라인 CTA(ContactPicker)와 플로팅 버튼(FloatingContactButton)이 공유한다.
    ...
    >
      ...
      >
        <div className="mb-5 flex items-start justify-between">
          <div>
            <h3 className="text-lg font-bold text-ink-900">어떻게 문의할까요?</h3>
        ...
        <div className="grid gap-3">
          {OPTIONS.map((o) => (
            ...
            >
              ...
              <ArrowRight size={18} className="ml-auto shrink-0 text-ink-300" />
            </a>
          ))}
        </div>
      </div>
