...
export const nav = {
  ...
  cta: { label: "30초 데모 보기", href: "/demo/play" },
};
...
export const hero = {
  ...
  subtitle: [
    "외국인 손님이 들어왔는데\n말이 통하지 않아 당황한 경험, 이제 줄일 수 있습니다.",
    "답답하고 복잡한 번역 앱 대신,\n더 자연스럽고 정돈된 응대 흐름을 만들어보세요.",
  ],
  primaryCta: { label: "30초 데모 보기", href: "/demo/play" },
...
export const benefits = {
  ...
  items: [
    ...
    },
    {
      icon: "languages",
      title: "번역앱 왔다 갔다 끝",
      desc: "손님의 말이 자동으로 한국어로 정리돼 도착합니다. 파파고 창을 띄울 필요가 없어요.",
    },
    {
      icon: "qr",
      title: "설치 없이 QR만",
      desc: "손님은 앱을 깔지 않습니다. 테이블 위 QR을 찍으면 바로 자기 언어 화면이 열립니다.",
    },
  ],
};

export const how = {
  title: "이용 방법은 세 단계면 충분합니다",
  steps: [
    {
      n: "01",
      title: "QR 스캔",
      desc: "손님이 매장 QR을 찍으면 스마트폰에 자기 언어 화면이 열립니다.",
    },
    {
      n: "02",
      title: "언어로 선택·질문",
      desc: "원하는 시술과 헤어 상태를 탭하고, 궁금한 점을 자기 언어로 남깁니다.",
    },
    {
      n: "03",
      title: "디자이너 폰에 한국어 알림",
      desc: "담당 디자이너 휴대폰으로 손님 요청이 한국어로 정리돼 바로 도착합니다.",
    },
  ],
};
